...
import com.cyj.tbr.entity.request.LoginRequestBody;
import com.cyj.tbr.entity.response.LoginResponseBody;
...
public class LoginController {
    ...
    public void login(@RequestBody LoginRequestBody requestBody,
        ...
        if (!firstName.isEmpty()) {
            ...
            response.getWriter().println(new ObjectMapper().writeValueAsString(loginResponseBody));
        } else {
