...
import com.cyj.tbr.service.RecommendationException;
import com.cyj.tbr.service.RecommendationService;
...
public class RecommendationController {
    ...
    public Map<String, List<Item>> recommendation(HttpServletRequest request) throws ServletException {
        ...
        try {
            if (session == null) {
                itemMap = recommendationService.recommendItemByDefault();
            } else {
